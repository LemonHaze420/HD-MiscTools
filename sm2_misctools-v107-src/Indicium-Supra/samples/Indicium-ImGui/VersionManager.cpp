...
// Source: https://github.com/Raymonf/Forklift/blob/master/Forklift/VersionManager.cpp
...
VersionManager::VersionManager()
{
	...
	default:
		MessageBoxA(NULL, "Unsupported Shenmue game version. Please check for an update.", "Shenmue Misc Tools Loader Error", MB_OK);
		break;
	}
}
